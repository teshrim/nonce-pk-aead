...
The latter viewpoint is the one taken by Bellare and Tackmann~\cite{mihir}, where nonce-based PKE is viewed as a method for hedging against bad randomness generation.
