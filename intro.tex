...
\paragraph{Prior work on PKE with associated data. } \tsnote{Definitely some work to consider.  Traditionally called ``labeled'' PKE I believe.  Start by finding Shoup's paper: \texttt{http://www.shoup.net/papers/kdm-cca2.pdf}}
