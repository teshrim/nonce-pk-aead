...
\newcommand{\AdvINDCPA}[2]{\Adv^{\mathrm{ind\mbox{-}cpa}}_{#1}{(#2)}}
\newcommand{\ExpINDCPA}[2]{\Exp^{\mathrm{ind\mbox{-}cpa}}_{#1}{(#2)}}
...
\newcommand{\queryl}[1]{\underline{\procfont{On query} {#1}:}}
\newcommand{\oracle}[1]{\underline{\procfont{oracle} {#1}:}}
\newcommand{\oraclev}[1]{\underline{\procfont{oracle} {#1}:}\smallskip}
\newcommand{\game}[2]{\underline{\procfont{Game} {\; #1}(#2):}}
\newcommand{\gamev}[2]{\underline{\procfont{Game} {\; #1}(#2):}\smallskip}
...
\newcommand{\sencprim}[3]{\mathsf{se}.\enc_{#1}^{#2}(#3)}
\newcommand{\sdecprim}[3]{\mathsf{se}.\dec_{#1}^{#2}(#3)}
