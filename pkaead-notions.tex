...
\fpage{.5}{
 ...
 Return $\Encprim{\pk}{\header,\pubiv}{S,M_b}$
 }
}
\caption{Privacy notion for an IV-based PK-AEAD scheme~$\pkaead$.  Secret-AD is produced by~$\mdalg$.  The key-pair is produced using registration-data~$\kreg$.}
\label{fig:ind-cda}
\end{center}
\end{figure}
